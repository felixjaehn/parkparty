...
import 'mehrfachbearbeitung_bottomsheet_viewmodel.dart';

class MehrfachBearbeitungBottomSheetView extends StatelessWidget {
  final SheetRequest? request;
  final Function(SheetResponse)? completer;
  final int index;
  const MehrfachBearbeitungBottomSheetView({
    required this.index,
    Key? key,
    this.request,
    this.completer,
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<MehrfachBearbeitungBottomSheetViewModel>.reactive(
                    ...
                    child: Column(
                      children: [
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Text(
                                          "${model.mehrfachAuswahl.length}/${model.produkt.auswahlAnzahl ?? 3}",
                                          style: GoogleFonts.roboto(
                                            textStyle: TextStyle(
                                                color:
                        ...
                        Divider(
                            ...
                            color: CupertinoColors.opaqueSeparator),
                        Column(
                          children: model.produkt.auswahlElemente
                            ...
                            return Column(
                              children: [
                                ...
                                if (model.produkt.auswahlElemente
                                        .indexOf(auswahlElement) !=
                                    model.produkt.auswahlElemente.length - 1)
                                  Divider(
                                      thickness: 0.4,
                                      color: CupertinoColors.opaqueSeparator),
                              ],
      ...
      viewModelBuilder: () => MehrfachBearbeitungBottomSheetViewModel(),
    );
  }
}
